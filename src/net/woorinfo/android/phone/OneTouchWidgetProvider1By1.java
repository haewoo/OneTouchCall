...
public class OneTouchWidgetProvider1By1 extends AppWidgetProvider {
    @Override
    public void onReceive(Context context, Intent intent) {
        ...
        if ( FavoriteSelectActivity.ACTION_APPWIDGET_UPDATE_1BY_1.equals(intent.getAction()) ) {
            ...
            onUpdate(context, appWidgetManager, appWidgetManager.getAppWidgetIds(new ComponentName(context, OneTouchWidgetProvider1By1.class)));
        }
    }
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for(int i = 0; i < appWidgetIds.length; i++ ) {
            ...
            RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.onebyone);
            SharedPreferences pref = null;
            pref = context.getSharedPreferences("OneTouchWidgetProvider1By1", Activity.MODE_PRIVATE);
            ...
            if ( dispName == null || "Who?".equals(dispName)) {
                ...
                intent.putExtra(FavoriteSelectActivity.ACTION_APPWIDGET, FavoriteSelectActivity.ACTION_APPWIDGET_UPDATE_1BY_1);
