...
public class OneTouchWidgetProvider4By1 extends AppWidgetProvider {
...
//        R.id.btn5
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ( intent.getAction().equals(OneTouchCallActivity.ACTION_APPWIDGET_UPDATE) ) {
            ...
            onUpdate(context, appWidgetManager, appWidgetManager.getAppWidgetIds(new ComponentName(context, OneTouchWidgetProvider4By1.class)));
        }
    }
